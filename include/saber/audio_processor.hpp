...
struct AudioProcessor {
	...
	using Frame = std::array<opus_int16, k_pcm_samples>;
   ...
   private:
	...
	Result<> send_frame(const Frame &pcm_frame, PlayerConnection *conn,
						const AudioSettings &settings,
						std::atomic<float> &limiter_gain, size_t frame_index,
						size_t fade_frames, float extra_gain,
